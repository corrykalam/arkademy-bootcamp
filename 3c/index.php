      ...
      <div class="container">
        <div class="col">
          <a class="navbar-brand" href="#">
            <img src="https://www.arkademy.com/img/logo%20arkademy.1c82cf5c.svg" width="70" height="30" alt="">
          </a>
        </div>
        <form class="col-10">
          <div class="row">
    ...
    <div class="container mt-3">
      <div class="row justify-content-center">
        <table class="table border" style="text-align: center">
          ...
          <tbody>
            <?php
              $connection = mysqli_connect('localhost', 'root', '', 'arkademy_camp');
            ...
            <tr>
              ...
              <td class="row">
                ...
                <form method="post" action="delete.php" class="col">
